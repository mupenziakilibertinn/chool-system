            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col justify-start space-y-4 flex-grow">
                  ...
                  {/* UNIFORM TABLE COLUMNS SECURED FOR ALL MODES */}
                  <table className="w-full text-center border-collapse border-4 border-black text-sm font-black print-table">
                    <thead className="bg-gray-100 border-b-4 border-black uppercase text-[10px] tracking-wider">
                      <tr>
                        ...
                        <th className={`p-2.5 border-r-2 border-black text-[10px] ${reportMode !== "summation" && reportMode !== "mid1" ? "opacity-30 bg-gray-50" : ""}`}>T1 (/50)</th>
                        <th className={`p-2.5 border-r-2 border-black text-[10px] ${reportMode !== "summation" && reportMode !== "mid1" ? "opacity-30 bg-gray-50" : ""}`}>M1 (/50)</th>
                        <th className={`p-2.5 border-r-2 border-black text-[10px] ${reportMode !== "summation" && reportMode !== "mid2" ? "opacity-30 bg-gray-50" : ""}`}>T2 (/50)</th>
                        <th className={`p-2.5 border-r-4 border-black text-[10px] ${reportMode !== "summation" && reportMode !== "mid2" ? "opacity-30 bg-gray-50" : ""}`}>M2 (/50)</th>
                    ...
                    <tbody>
                      {subjectsList.map((sub) => {
                        ...
                        return (
                          <tr key={sub} className="border-b-2 border-black text-gray-900 text-[13px] font-black">
                            ...
                            <td className={`p-2.5 border-r-2 border-black text-gray-950 ${reportMode !== "summation" && reportMode !== "mid1" ? "opacity-20 bg-gray-50 font-normal" : ""}`}>{t1}</td>
                            <td className={`p-2.5 border-r-2 border-black text-gray-950 ${reportMode !== "summation" && reportMode !== "mid1" ? "opacity-20 bg-gray-50 font-normal" : ""}`}>{m1}</td>
                            <td className={`p-2.5 border-r-2 border-black text-gray-950 ${reportMode !== "summation" && reportMode !== "mid2" ? "opacity-20 bg-gray-50 font-normal" : ""}`}>{t2}</td>
                            <td className={`p-2.5 border-r-4 border-black text-gray-950 ${reportMode !== "summation" && reportMode !== "mid2" ? "opacity-20 bg-gray-50 font-normal" : ""}`}>{m2}</td>
                      ...
                      <tr className="bg-blue-50/80 font-black text-blue-950 border-t-4 border-black text-xs tr-total">
                        <td colSpan={2} className="p-3 border-r-4 border-black text-center uppercase tracking-wider text-[11px]">
