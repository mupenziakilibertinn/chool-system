    ...
    <div className="p-4 bg-gray-100 min-h-screen text-[11px] font-black font-sans space-y-12">
      ...
      {students.length === 0 ? (
        ...
        students.map((student) => {
          ...
          const studentCo = coCurricularMarks[student.id] || {};
          const m = student.metrics;

          return (
            <div key={student.id} className="bg-white p-6 border-4 border-black max-w-5xl mx-auto space-y-12 page-break shadow-sm relative">
              {/* Watermark layout */}
                  ...
                  <table className="w-full text-center border-collapse border-2 border-black">
                    ...
                    <tbody>
                      {subjectsList.map((sub) => {
                        ...
                        const t3_ex = mData.term3_exam !== undefined && mData.term3_exam !== "" ? parseNumFallback(mData.term3_exam) : "-";
